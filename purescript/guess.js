...
(function(exports) {
  ...
  var main = function __do() {
      ...
      Control_Monad_Eff_Console.log("Guess the number!")();
      Control_Monad_Eff_Console.log("Please input your guess.")();
      Node_ReadLine.prompt(_1)();
      return Prelude.flip(Node_ReadLine.setLineHandler)(_1)(function (guess) {
          return function __do() {
              Control_Monad_Eff_Console.log("You guessed: " + guess)();
              ...
              throw new Error("Failed pattern match at /home/edwin/projects/something/purescript/src/Main.purs line 14, column 1 - line 32, column 26: " + [ _4.constructor.name ]);
          };
      })();
  };
  exports["main"] = main;
